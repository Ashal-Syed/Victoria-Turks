  ...
  return (
    ...
    >
      <div data-label="Heading" className="flex justify-center">
        <h1 className="heading-text font-medium text-3xl">About Us:</h1>
        <h1 className="text-black font-medium text-3xl ml-2">Who Are We?</h1>
      </div>
      <div data-label="Content" className="flex h-full justify-between items-center gap-5">
        <div data-label="Photo" className="w-1/3 h-full">
          <Image
            src="/about.jpg"
            alt="Istanbul"
            // fill
