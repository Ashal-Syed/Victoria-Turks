...
const Services = () => {
  return (
    ...
    >
      ...
      <p className="lg:px-30 text-center text-neutral-500 leading-loose">
      ...
      <div data-label="Row 1" className="w-full flex flex-wrap lg:flex-nowrap gap-10">
      ...
      <div data-label="Row 2" className="w-full flex flex-wrap lg:flex-nowrap gap-10">
